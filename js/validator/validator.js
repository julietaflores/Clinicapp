...
var validator = (function($){
    ...
    */
    message = {
        ...
        checked         : 'Debe ser seleccionado', //'must be checked',
        empty           : 'por favor, poner algo aqui',//'please put something here',
        min             : 'entrada muy corta', //'input is too short',
        max             : 'entrada muy larga', //'input is too long',
        number_min      : 'muy bajo',
        number_max      : 'muy alto',
        url             : 'URL incorrecta',
        number          : 'no es un numero',
        email           : 'direccion de correo incorrecta',
        email_repeat    : 'correo electronico no coincide',
        password_repeat : 'claves no coinciden',
        repeat          : 'no coincide',
        complete        : 'entrada no esta completa',
